...
class TodayEventList extends StatefulWidget {
  ...
  @override
  State<TodayEventList> createState() => _EventMainPageState();
}

class _EventMainPageState extends State<TodayEventList> {
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              if(snapshot.data!.isEmpty){
                return const Center(child: Text('No hay eventos planeados para hoy.', style: TextStyle(color: TEXT),));
              }
